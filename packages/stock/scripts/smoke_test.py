...
StockClient.profile() and the Parquet writer, end to end.
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Smoke-test equicast-stock (profile) against live yfinance data."
    )
    parser.add_argument(
        "--config",
        type=Path,
...
def run_ticker(ticker: StockTicker, output_format: str, output_dir: Path) -> None:
