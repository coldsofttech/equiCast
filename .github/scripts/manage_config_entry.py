...
manage-config.yml's workflow_dispatch inputs. Never touches `main`
directly; the workflow commits this script's edit on its own branch and
opens a PR (see that workflow for why).
