...
from .views import BulkCheckpointsView, TransactionDetailView, TransactionListView

urlpatterns = [
    path("", TransactionListView.as_view(), name="transactions-list"),
    # Ahead of <holding_id>/<transaction_id>/ so "import"/"bulk" are never
    # captured as a holding_id.
    ...
    path("bulk/checkpoints/", BulkCheckpointsView.as_view(), name="transactions-bulk-checkpoints"),
