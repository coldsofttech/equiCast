...
class WatchlistListView(APIView):
    ...
    def get(self, request: Request) -> Response:
        ...
        account_pie_holdings = [
            ...
            if h.get("account_id") is not None or h.get("pie_id") is not None
        ]
        ...
        system = [
            {**w, "type": "system", "holdings": _system_holdings(w["id"])}
...
class WatchlistDetailView(APIView):
    ...
    def get(self, request: Request, watchlist_id: str) -> Response:
        ...
        enriched_holdings = _enrich_holdings(request.user.user_id, holdings)
        return Response({**watchlist, "type": "custom", "holdings": enriched_holdings})
