 ...
 * ComingSoonPage — see WatchlistsPage), "Goals", "Import transactions",
 * and "Support" (GitHub issue #246 — SupportPage) — "Settings" (opens
 * SettingsModal), and the sign-out action. Only rendered inside AppShell,
