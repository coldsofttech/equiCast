 ...
 * `user` — no extra API round trip), "Accounts" and "Import transactions"
 * (its only two nav entry points now that MenuBar is gone), "Settings"
 * (opens SettingsModal), and the sign-out action. Only rendered inside
 * AppShell, which only mounts once RequireAuth has already confirmed
