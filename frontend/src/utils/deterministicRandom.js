 ...
 * (sampleFinancials.js) so a given input always renders the same synthetic
 * shape instead of reshuffling on every re-render, without pulling in a
 * real random-number or charting library for what's explicitly placeholder
 * data.
 */
